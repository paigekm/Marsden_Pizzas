...
def update(mo):
    ...
    indextochange_choice = get_validated_integer("Please enter the index number (far left column) of the pizza you would like to update:", 0,
                                         len(mo) - 1)
